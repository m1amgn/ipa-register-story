...
const MintLicenseTokensPage: React.FC = () => {
    ...
    const mintingFee = BigInt(searchParams.get('fee') ?? '0');
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    type="number"
                                    name="amount"
                                    value={licenseTokenAmount}
                                    onChange={(e) => setLicenseTokenAmount(parseInt(e.target.value, 10))}
                                    min="1"
                                    required
